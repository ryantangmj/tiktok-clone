<template>    
    ...
    <UploadLayout>
        <div class="w-full mt-[80px] mb-[40px] bg-white shadow-lg rounded-md py-6 md:px-10 px-4">
            <div>
                <div class="text-[23px] font-semibold">Upload Product to Sell</div>
                <div class="text-gray-400 mt-1">Upload Product Picture</div>
            </div>
            ...
            <div class="mt-8 md:flex gap-6">
                ...
                >
                    ...
                    <div class="mt-4 text-[17px]">Select picture to upload</div>
                    <div class="mt-1.5 text-gray-500 text-[13px]">Or drag and drop a file</div>
                    <div class="mt-12 text-gray-400 text-sm">PNG</div>
                ...
                <div class="mt-4 mb-6">
                    <div class="flex bg-[#F8F8F8] py-4 px-6">
                        ...
                        <div>
                            <div class="text-semibold text-[15px] mb-1.5">Edit Product Image</div>
                            <div class="text-semibold text-[13px] text-gray-400">
                                You can quickly edit photos, crop them, add captions or use some of tiktok filters / effects.
                            </div>
                        </div>
                    ...
                    <div class="mt-5">
                        <div class="flex items-center justify-between">
                            <div class="mb-1 text-[15px]">Product Name</div>
                        </div>
                        <input
                            v-model="productName"
                            type="text"
                        ...
                        <div class="mt-5">
                        <div class="flex items-center justify-between">
                            <div class="mb-1 text-[15px]">Product Description</div>
                        </div>
                        <textarea
                        ...
                        <div class="mt-5">
                        <div class="flex items-center justify-between">
                            <div class="mb-1 text-[15px]">Product Price</div>
                        </div>
                        <input
